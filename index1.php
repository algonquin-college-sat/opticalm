  ...
  <div class="form-group col-12">
    <form class="col-md-6" action="index2.php" method="POST">
      <div class="form-check">
        ...
        <input class="form-check-input" type="checkbox" value="Colours" id="defaultCheck1" name="Colours" />
        <label class="form-check-label" for="defaultCheck1">Colours</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Contrast" id="defaultCheck2" name="Contrast" />
        <label class="form-check-label" for="defaultCheck2">Contrast</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Flicker" id="defaultCheck3" name="Flicker" />
        <label class="form-check-label" for="defaultCheck3">Flicker</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Glare" id="defaultCheck4" name="Glare" />
        <label class="form-check-label" for="defaultCheck4">Glare</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Light" id="defaultCheck5" name="Light" />
        <label class="form-check-label" for="defaultCheck5">Light (bright or fluoresent</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Motion" id="defaultCheck6" name="Motion" />
        <label class="form-check-label" for="defaultCheck6">Motion</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Patterns" id="defaultCheck7" name="Patterns" />
      ...
      <div class="form-check">
        ...
        <input class="form-check-input" type="checkbox" value="Attention/Concentration" id="defaultCheck8" name="" />
        <label class="form-check-label" for="defaultCheck8">Attention/Concentration</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck9" name="" />
        <label class="form-check-label" for="defaultCheck9">Balance</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck10" name="" />
        <label class="form-check-label" for="defaultCheck10">Cognitive Fatique</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck111" name="" />
        <label class="form-check-label" for="defaultCheck11">Headache</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck12" name="" />
        <label class="form-check-label" for="defaultCheck12">Perception</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck13" name="" />
        <label class="form-check-label" for="defaultCheck13">Reading</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck14" name="" />
        <label class="form-check-label" for="defaultCheck14">Tracking(when reading)</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="defaultCheck15" name="" />
